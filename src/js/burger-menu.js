var burgerMenu = {
  ...
  init: function() {
    ...
    burgerMenu.el.btnToggleOpen = document.querySelector(".burger-menu-toggle.open")
    burgerMenu.el.btnToggleClose = document.querySelector(".burger-menu-toggle.close")
